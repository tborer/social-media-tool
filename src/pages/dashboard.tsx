                  ...
                  <Dialog open={isCreatingPost} onOpenChange={setIsCreatingPost}>
                    ...
                    <DialogContent className="sm:max-w-[525px] max-h-[90vh]">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Craft your post and publish to one or more connected platforms.
                        </DialogDescription>
                      </DialogHeader>
                        ...
                        <div className="grid gap-4 py-4">
                          ...
                          <div className="grid gap-2">
                            ...
                            <div className="flex justify-between text-xs text-muted-foreground mt-1">
                              <span className={newPost.caption.length > 3000 ? 'text-destructive font-medium' : ''}>
                                {newPost.caption.length} characters
                              </span>
                              <span className={(newPost.caption.match(/#\w+/g) || []).length > 30 ? 'text-destructive font-medium' : ''}>
                                {(newPost.caption.match(/#\w+/g) || []).length} hashtags
                              </span>
                            </div>
                            <Button 
                              variant="outline" 
                                  ...
                                  {accounts
                                    ...
                                    .map(acct => {
                                      ...
                                      if (acct.accountType === 'LINKEDIN') {
                                        ...
                                        return (
                                          <div key={acct.id} className={`text-xs px-2 py-1 rounded flex items-center gap-1 ${over ? 'bg-red-50 text-red-700 border border-red-200' : len > 2700 ? 'bg-amber-50 text-amber-700 border border-amber-200' : 'text-muted-foreground bg-muted/40'}`}>
