...
const STYLE_PRESETS = [
  { value: 'photorealistic', label: 'Photorealistic', description: 'High-quality photograph' },
  { value: 'artistic', label: 'Artistic', description: 'Painterly illustration' },
  { value: 'cartoon', label: 'Cartoon', description: 'Colorful vector art' },
  ...
  { value: 'cinematic', label: 'Cinematic', description: 'Dramatic lighting' },
];

const ASPECT_RATIOS = [
  { value: 'square', label: 'Square', description: '1:1 — Instagram feed', icon: '▪' },
  { value: 'portrait', label: 'Portrait', description: '4:5 — Instagram portrait', icon: '▐' },
  { value: 'landscape', label: 'Landscape', description: '16:9 — LinkedIn / X', icon: '▬' },
  { value: 'story', label: 'Story', description: '9:16 — Stories / Reels', icon: '▌' },
];
            ...
            <div className="grid grid-cols-4 gap-2">
              {STYLE_PRESETS.map((preset) => (
                ...
                >
                  ...
                  <div className="text-muted-foreground mt-0.5">{preset.description}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-4 gap-2">
              {ASPECT_RATIOS.map((ratio) => (
                ...
                >
                  <div className="text-lg leading-none mb-1">{ratio.icon}</div>
                  <div className="font-medium">{ratio.label}</div>
                  <div className="text-muted-foreground mt-0.5">{ratio.description}</div>
                </button>
              ))}
            </div>
          </div>
              ...
              {generatedImages.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground mb-2">
                    Style: <span className="capitalize font-medium">{selectedStyle}</span> &middot; Aspect ratio: <span className="capitalize font-medium">{selectedAspectRatio}</span>
                  </div>
